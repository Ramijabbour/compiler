...
create_table_definition :
      (T_AS? T_OPEN_P select_stmt T_CLOSE_P | T_AS? select_stmt | T_OPEN_P create_table_columns T_CLOSE_P) create_table_options_ed? create_table_options?
     ;
...
global_scope :
    function_name T_OPEN_B (varss | function_stmnt)* function_end T_CLOSE_B
...
function_stmnt :
    return_type function_name T_OPEN_P  (pars* | T_CLOSE_P)  T_OPEN_B functions* function_end T_CLOSE_B
         ;
pars:
    dtypee column_name T_CLOSE_P
...
functions:
    ...
    ;
//vars:
  //   dtype column_name (T_COMMA column_name)* T_SEMICOLON
   // ;
...
create_table_hive_row_format_fields :
       T_FIELDS T_TERMINATED T_BY expr
